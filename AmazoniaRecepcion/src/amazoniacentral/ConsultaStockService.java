...
public class ConsultaStockService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:63083/ConsultaStock?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ConsultaStockService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:63083/ConsultaStock?wsdl");
        }
        WSDL_LOCATION = url;
    }

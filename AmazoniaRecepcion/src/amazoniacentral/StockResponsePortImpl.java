...
public class StockResponsePortImpl implements StockResponse {
    ...
    public amazoniacentral.ConfirmacionResponse obtenerStockResponse(java.lang.String arg0) { 
        ...
        try {
            ...
            _return.setIdCompra("IdCompra-725632818");
            _return.setIdReserva("IdReserva-85764841");
            _return.setCodResultado(Integer.valueOf(743124534));
            _return.setDescripcionResultado("DescripcionResultado889680858");
            return _return;
